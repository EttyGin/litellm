"""
max-tokens debug logging (pre-existing, unrelated to the empty-content guard).

Self-installs on import (gated by env CUSTOM_DEBUG). Wraps
get_modified_max_tokens to log the value going in and out — original logic
unchanged. Kept separate so each patch has a single purpose.
"""
import os
